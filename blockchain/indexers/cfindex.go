...
func storeFilter(dbTx database.Tx, block *wfcutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *wfcutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *wfcutil.Block,
