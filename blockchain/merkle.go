...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*wfcutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *wfcutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *wfcutil.Block) error {
