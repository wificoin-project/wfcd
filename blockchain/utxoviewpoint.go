...
func (view *UtxoViewpoint) AddTxOut(tx *wfcutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *wfcutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *wfcutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *wfcutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *wfcutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *wfcutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *wfcutil.Tx) (*UtxoViewpoint, error) {
