...
func GetBlockWeight(blk *wfcutil.Block) int64 {
...
func GetTransactionWeight(tx *wfcutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *wfcutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
