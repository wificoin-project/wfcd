...
var (
	...
	mainPowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 244), bigOne)
	...
	// 2^224 - 1.
	testNet3PowLimit = new(big.Int).Sub(new(big.Int).Lsh(bigOne, 244), bigOne)
...
var MainNetParams = Params{
	...
	RuleChangeActivationThreshold: 10944, // 95% of MinerConfirmationWindow
	MinerConfirmationWindow:       11520, //
	Deployments: [DefinedDeployments]ConsensusDeployment{
		DeploymentTestDummy: {
			BitNumber:  28,
...
var TestNet3Params = Params{
	...
	// The miner confirmation window is defined as:
	//   target proof of work timespan / target proof of work spacing
	RuleChangeActivationThreshold: 10944, // 75% of MinerConfirmationWindow
	MinerConfirmationWindow:       11520,
	Deployments: [DefinedDeployments]ConsensusDeployment{
		DeploymentTestDummy: {
			BitNumber:  28,
