...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*wfcutil.Block, error) {
	...
	blocks := make([]*wfcutil.Block, 0, 256)
	genesis := wfcutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
