...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr wfcutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*wfcutil.Tx, error) {
...
func CreateBlock(prevBlock *wfcutil.Block, inclusionTxs []*wfcutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr wfcutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*wfcutil.Block, error) {
	...
	blockTxns := []*wfcutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := wfcutil.NewBlock(&block)
