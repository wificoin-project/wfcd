...
func New(activeNet *chaincfg.Params, handlers *rpcclient.NotificationHandlers,
	...
	if handlers.OnFilteredBlockConnected != nil {
		...
		handlers.OnFilteredBlockConnected = func(height int32, header *wire.BlockHeader, filteredTxns []*wfcutil.Tx) {
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// wallet.
	filterAddrs := []wfcutil.Address{h.wallet.coinbaseAddr}
...
func (h *Harness) NewAddress() (wfcutil.Address, error) {
...
//
// This function is safe for concurrent access.
func (h *Harness) ConfirmedBalance() wfcutil.Amount {
...
//
// This function is safe for concurrent access.
func (h *Harness) GenerateAndSubmitBlock(txns []*wfcutil.Tx, blockVersion int32,
	blockTime time.Time) (*wfcutil.Block, error) {
...
func (h *Harness) GenerateAndSubmitBlockWithCustomCoinbaseOutputs(
	txns []*wfcutil.Tx, blockVersion int32, blockTime time.Time,
	mineTo []wire.TxOut) (*wfcutil.Block, error) {
	...
	prevBlock := wfcutil.NewBlock(mBlock)
