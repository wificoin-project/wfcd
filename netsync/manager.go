...
import (
	...
	peerpkg "github.com/wificoin-project/wfcd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*wfcutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *wfcutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *wfcutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *wfcutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
