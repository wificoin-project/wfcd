...
//
// NOTE: This is a btcd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []wfcutil.Address, account string) FutureListAddressTransactionsResult {
...
//
// NOTE: This is a btcwallet extension.
func (c *Client) ListAddressTransactions(addresses []wfcutil.Address, account string) ([]btcjson.ListTransactionsResult, error) {
