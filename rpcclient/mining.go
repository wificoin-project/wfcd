...
func (c *Client) SubmitBlockAsync(block *wfcutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *wfcutil.Block, options *btcjson.SubmitBlockOptions) error {
