...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []wfcutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []wfcutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee wfcutil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee wfcutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address wfcutil.Address, amount wfcutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address wfcutil.Address, amount wfcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address wfcutil.Address,
	amount wfcutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address wfcutil.Address, amount wfcutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress wfcutil.Address, amount wfcutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress wfcutil.Address, amount wfcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress wfcutil.Address, amount wfcutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress wfcutil.Address, amount wfcutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress wfcutil.Address, amount wfcutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress wfcutil.Address,
	amount wfcutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[wfcutil.Address]wfcutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[wfcutil.Address]wfcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[wfcutil.Address]wfcutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[wfcutil.Address]wfcutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (wfcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return wfcutil.DecodeAddress(addr, &chaincfg.MainNetParams)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []wfcutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []wfcutil.Address, account string) (wfcutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []wfcutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []wfcutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (wfcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (wfcutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (wfcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (wfcutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (wfcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddress(address string) (wfcutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (wfcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (wfcutil.Address, error) {
...
func (c *Client) GetAccountAsync(address wfcutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address wfcutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address wfcutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address wfcutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]wfcutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]wfcutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := wfcutil.DecodeAddress(addrStr,
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]wfcutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount wfcutil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount wfcutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount wfcutil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount wfcutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount wfcutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount wfcutil.Amount,
...
func (c *Client) ValidateAddressAsync(address wfcutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address wfcutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]wfcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]wfcutil.Amount)
	for k, v := range accounts {
		amount, err := wfcutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]wfcutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]wfcutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (wfcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := wfcutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (wfcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (wfcutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (wfcutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (wfcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (wfcutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (wfcutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (wfcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (wfcutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (wfcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address wfcutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address wfcutil.Address) (wfcutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address wfcutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address wfcutil.Address, minConfirms int) (wfcutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address wfcutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address wfcutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address wfcutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address wfcutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*wfcutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return wfcutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address wfcutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address wfcutil.Address) (*wfcutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *wfcutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *wfcutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *wfcutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *wfcutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *wfcutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *wfcutil.WIF, label string, rescan bool) error {
