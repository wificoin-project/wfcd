...
func ExamplePayToAddrScript() {
	// Parse the address to send the coins to into a wfcutil.Address
	// which is useful to ensure the accuracy of the address and determine
	// the address type.  It is also required for the upcoming call to
	// PayToAddrScript.
	addressStr := "12gpXQVcCL2qhTNQgyLVdCFG2Qs2px98nV"
	address, err := wfcutil.DecodeAddress(addressStr, &chaincfg.MainNetParams)
	if err != nil {
		fmt.Println(err)
		return
	}
...
func ExampleSignTxOutput() {
	...
	addr, err := wfcutil.NewAddressPubKeyHash(pubKeyHash,
	...
	lookupKey := func(a wfcutil.Address) (*btcec.PrivateKey, bool, error) {
